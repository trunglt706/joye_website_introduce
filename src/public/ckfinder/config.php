 ...
 * GET license key at: https://www.phamgiang.pro/apps/ckfinderKey
...
$config['licenseName'] = 'hieuvathuong.vn';
$config['licenseKey']  = '2FNFA918KP8V7LWMDP65C8Y68KRG9';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => '/public/ckfinder/core/connector/php/uploads/',
    // 'root'         => 'ckfinder/core/connector/php/uploads/', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
