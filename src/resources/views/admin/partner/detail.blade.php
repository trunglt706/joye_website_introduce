@php
    ...
    $status = Partner::get_status($data->status);
@endphp
@extends('admin.index')
@section('content')
    <div class="container-lx px-4 mb-3">
        <nav aria-label="breadcrumb" class="hide-mobile">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('admin.partner.index') }}">Danh sách đối tác</a>
                </li>
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                <tr>
                    <td class="bg-body-secondary w-175px text-nowrap">- Tên đối tác</td>
                    <td>{{ $data->name }}</td>
        ...
        <div class="row">
            <div class="col-md-6 mb-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.partner.update') }}" method="POST" class="form-update">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-2">
                                    <div class="mb-2 form-group">
                                        <label class="form-label">Lien kết</label>
