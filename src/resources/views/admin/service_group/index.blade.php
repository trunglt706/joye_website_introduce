...
@section('content')
    <div class="container-lx px-4 mb-3">
        ...
        @include('admin.service_group.filter')
            ...
            <table class="table border mb-0">
                <thead class="fw-semibold text-nowrap">
                    <tr class="align-middle">
                        ...
                        <th class="bg-body-secondary text-end">Số dịch vụ</th>
    ...
    @include('admin.service_group.create')
@endsection
@push('js')
    <script src="{{ asset('ckeditor/ckeditor.js') }}"></script>
    <script src="{{ asset('ckfinder/ckfinder.js') }}"></script>
    <script>
        const routeList = "{{ route('admin.service_group.table') }}";
        filterTable();
        ...
        function confirmDelete(id) {
            deleteData(id, "{{ route('admin.service_group.destroy') }}");
        }
