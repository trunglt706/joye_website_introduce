            ...
            <div class="col-md-6 mb-2">
                <div class="strm-cont wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <h5 class="text-justify" style="line-height: 40px;">
                        ...
                        mỗi cá nhân, bởi chúng tôi tin rằng mỗi người đều mang trong mình những tài năng riêng biệt và
                        giá trị đáng được nuôi dưỡng và phát huy.
                    </h5>
                </div>
            </div>
            <div class="col-md-6 mb-2">
                <img src="/style/images/staff.webp" class="img-fluid" alt="">
            </div>
        </div>
    </div>
</section>
