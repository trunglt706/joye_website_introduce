...
<link rel="stylesheet" href="{{ asset('style2/library/menu/webslidemenu.css') }}">
<link rel="stylesheet" href="{{ asset('style2/library/menu/webslidemenu-effect.css') }}">
<link rel="stylesheet" href="{{ asset('style2/css/mystyle.css') }}">
@if (in_array(Route::currentRouteName(), ['v2.blog.detail']))
